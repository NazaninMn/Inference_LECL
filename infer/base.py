...
#         net = model_creator( **self.method["model_args"]) #TODO:nazanin
        
        net = model_creator(buffer_size=5000, feat_dim=256, **self.method["model_args"]) #TODO:nazanin
        saved_state_dict = torch.load(self.method["model_path"], map_location=device)["desc"]
