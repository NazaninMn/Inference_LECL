...
def gen_targets(ann, crop_shape, **kwargs):
    ...
    hv_map = gen_instance_hv_map(ann[:,:,0], crop_shape)    #TODO: Nazanin, I added [:,:,0] here
    np_map = ann[:,:,0].copy()          #TODO: Nazanin, I added [:,:,0] here
    np_map[np_map > 0] = 1
    semi_map = ann[:, :, 1].copy()     #TODO: Nazanin, I added semi here
    semi_map[semi_map > 0] = 1

    hv_map = cropping_center(hv_map, crop_shape)
    np_map = cropping_center(np_map, crop_shape)
    semi_map = cropping_center(semi_map, crop_shape)#TODO: Nazanin, I added
