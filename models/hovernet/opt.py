        ...
        "phase_list": [
            {
                "run_info": {
                    ...
                    "net": {
                        "desc": lambda: create_model(buffer_size = 5000, feat_dim=256,  #TODO: buffer size based on the batch size
                        ...
                        "pretrained": "/scratch/nm4wu/AHA/hover_net/models/hovernet/ImageNet-ResNet50-Preact_pytorch.tar",
                        # 'pretrained': None,
                    },
                },
...

            {
                "run_info": {
                    # may need more dynamic for each network
                    "net": {
                        "desc": lambda: create_model(buffer_size=5000, feat_dim=256,
                            input_ch=3, nr_types=nr_type, 
                ...
                "target_info": {"gen": (gen_targets, {}), "viz": (prep_sample, {})},
                "batch_size": {"train": 3, "valid": 8,}, # batch size per gpu
                "nr_epochs": 100,
            },
        ],
        # ------------------------------------------------------------------
