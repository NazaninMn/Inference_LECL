...
class FileLoader(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        inst_map = ann[..., 0:2]  # HW1 -> HW # TODO: Nazanin:change 0==>0:2 based on adding semi. add semi befor type
        if self.with_type:
            type_map = (ann[..., 2]).copy() # TODO: Nazanin:change 1 ==>2 based on adding semi. add semi befor type
